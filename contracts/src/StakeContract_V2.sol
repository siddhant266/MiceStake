...
contract StakeContract_V2 is Ownable, ReentrancyGuard {
    ...
    uint256 public constant rewardRate = 15;        // 15% APR
    uint256 public constant timeFactor = 10;        // speed multiplier for testing
    uint256 public constant rewardMultiplier = 100;
